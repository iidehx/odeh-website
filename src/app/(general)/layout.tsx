...
export const metadata: Metadata = {
  ...
  description:
    "Omar Odeh, CPA provides bookkeeping, budgeting, financial consulting, cash flow management, tax preparation, and business management, with specialized experience in dental clinics, therapy practices, and real estate businesses.",
  keywords: [
    "Omar Odeh CPA",
  ...
  openGraph: {
    title: "Omar Odeh, CPA | Accounting for Growing Businesses",
    description:
      "Bookkeeping, budgeting, financial consulting, cash flow management, tax preparation, and business management, with specialized experience in dental clinics, therapy practices, and real estate businesses.",
    url: "/",
